...
def create_todo():
    if request.method == "POST":
        ...
        return render_template("success.html", color=color, title=title, description=description)
    return render_template("create-todo.html")
...
def edit_todo(todo_number: str):
    if request.method == "POST":
        ...
        return render_template("edit-success.html", color=color, title=title, description=description)
